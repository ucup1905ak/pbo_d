 ...
 */
public class PaketLengkap extends PaketServis {

    private String fasilitas_paket;

    public PaketLengkap(String id, String nama, String jenis, int durasi, String fasilitas_paket) throws InputKosongException {
        super(id, nama, "Lengkap", durasi);
        this.fasilitas_paket = fasilitas_paket;
    }

    public PaketLengkap(String nama, String jenis, int durasi, String fasilitas_paket) throws InputKosongException {
        super(nama, "Lengkap", durasi);
        this.fasilitas_paket = fasilitas_paket;
    }

    public PaketLengkap(ResultSet rs) throws SQLException, InputKosongException {
