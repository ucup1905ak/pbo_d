...
public class TransaksiMainPanel extends javax.swing.JPanel {
    ...
    public void setKendaraanToDropdown() {
        ...
        for (int i = 0; i < listKendaraan.size(); i++) {
            namaKendaraanDropdown.addItem(listKendaraan.toString());
        }
    }
    ...
    public void setCustomerToDropdown() {
        ...
        for (int i = 0; i < listCustomer.size(); i++) {
            namaCustomerDropdown.addItem(listCustomer.toString());
        }
    }
    ...
    private void initComponents() {
        ...
        namaCustomerDropdown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        namaKendaraanDropdown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(searchTransaksiInputPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 899, Short.MAX_VALUE)
                    .addComponent(transaksiFormPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 899, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void hapusTransaksiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusTransaksiButtonActionPerformed
        ...
        pemilikControl.deletePemilikKendaraan(selectedId);

        clearText();
        setComponent(false);
        setEditDeleteBtn(false);
        setRadioComponent(false);
        modePerubahanGroup.clearSelection();
        tambahTransaksiButton.setEnabled(true);
    ...
    private void simpanTransaksiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanTransaksiButtonActionPerformed
        ...
        try {
            ...
            if (JOptionPane.showConfirmDialog(rootPane, "Total pembayaran yang perlu Anda bayarkan adalah : Rp. " + totalHarga)
                ...
                if (action.equals("tambah")) {
                    PembelianKendaraan pk = new PembelianKendaraan(selectedCustomer.getId_customer(),
                            ...
                            metodePembayaran, selectedCustomer);
                    pembelianControl.insertDataPembelianKendaraan(pk);
                } else {
                    PembelianKendaraan pk = new PembelianKendaraan(selectedCustomer.getId_customer(),
                            Integer.parseInt(jumlahPembelianInput.getText()), selectedKendaraan.getId_kendaraan(), atribut,
                            metodePembayaran);
                    pembelianControl.updatePemihelianKendaraan(pk, selectedId);
                    selectedId = -1;
                }
            }
