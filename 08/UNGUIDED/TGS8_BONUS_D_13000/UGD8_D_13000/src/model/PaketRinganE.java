 ...
 */
public class PaketRinganE extends PaketServisE {

    private String layanan_tambahan;

    public PaketRinganE(String id, String nama, String jenis, int durasi, String layanan_tambahan) throws InputKosongException {
        super(id, nama, "Ringan", durasi);
        this.layanan_tambahan = layanan_tambahan;
    }

    public PaketRinganE(String nama, String jenis, int durasi, String layanan_tambahan)throws InputKosongException  {
        super(nama, "Ringan", durasi);
        this.layanan_tambahan = layanan_tambahan;
    }

    public PaketRinganE(ResultSet rs) throws SQLException, InputKosongException {
