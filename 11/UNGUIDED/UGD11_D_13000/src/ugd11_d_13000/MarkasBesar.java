...
public class MarkasBesar {
    //UGD11
    private static MarkasBesar markasBesar = null;
    
    
    public static MarkasBesar getMarkasBesar(String namaMarkas, int tahunBerdiri, double kas){
        if(markasBesar == null){
            markasBesar = new MarkasBesar(namaMarkas, tahunBerdiri, kas);
            System.out.println("Berhasil membuat objek baru");
        }else{
            System.out.println("[!] Markas Besar Sudah Ada [!]");
        }
